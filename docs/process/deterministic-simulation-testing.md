...
Activity request commits. Two real Absurd/PostgreSQL profiles additionally
prove that a refused joined commit or a failing joined task spawn rolls back
both the semantic begin and task custody before fresh-load reconstruction.
