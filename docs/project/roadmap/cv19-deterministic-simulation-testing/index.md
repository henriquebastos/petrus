...
level: Value
status: Active
status_reason: CV19.DS1 is Done and DS2's supported v3 World now adds lifecycle/timer reconstruction and LocalDispatch retry plus terminal custody to seeded exact replay and terminal cuts; broader adapters/bounds and DS3–DS4 remain active
updated: 2026-08-18
related:
...
2. [CV19.DS2 — Deterministic event and fault harness](cv19-ds2-deterministic-event-and-fault-harness.md)
   ...
   projection after pre-collection process loss. The broader fault/cut matrix
   and remaining bounds keep DS2 active.
